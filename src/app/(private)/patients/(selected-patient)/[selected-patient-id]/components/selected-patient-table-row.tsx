...
export function SelectedPatientTableItem({ appointment }: Props) {
  const { setSelectedAppointment } = useGeneralContext();
    ...
    >
      ...
      <TableCell
        onClick={() => {
          ...
          router.push(`${pathname}/${appointment.id}`);
        }}
        className="py-2 text-end text-sm font-medium whitespace-nowrap text-zinc-400 underline"
      >
        4
      </TableCell>
    </TableRow>
